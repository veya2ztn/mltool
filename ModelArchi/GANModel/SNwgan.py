...
class Discriminator(torch.nn.Module):
    def __init__(self, channels):
        ...
        self.output = nn.Sequential(
            ...
            SpectralNorm(nn.Conv2d(in_channels=1024, out_channels=1, kernel_size=4, stride=1, padding=0)))
    ...
    def train(self, train_loader):
        ...
        for g_iter in range(self.generator_iters):
            ...
            for d_iter in range(self.critic_iter):
                ...
                for p in self.D.parameters():_=p.data.clamp_(-self.weight_cliping_limit, self.weight_cliping_limit)
            ...
            # Generator update
            for p in self.D.parameters():p.requires_grad = False  # to avoid computation
