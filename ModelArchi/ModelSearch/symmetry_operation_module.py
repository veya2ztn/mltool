...
from ..SymmetryCNN import D4_Conv2d
class ReLUcclConvBN(nn.Module):
    def __init__(self, C_in, C_out, k, s, d, circularQ=True,affine=True):
        ...
        self.op = nn.Sequential(
          ...
          D4_Conv2d(C_in, C_out, k, stride=s, padding=pp,dilation=d, bias=False,padding_mode="circular" if circularQ else 'zeros'),
...
class ReLUConvBN(nn.Module):
  def __init__(self, C_in, C_out, kernel_size, stride, padding, affine=True):
    ...
    self.op = nn.Sequential(
      nn.ReLU(inplace=False),
      D4_Conv2d(C_in, C_out, kernel_size, stride=stride, padding=padding, bias=False),
      AdaptiveBatchNorm2d(C_out, affine=affine)
    )
  def forward(self, x):
    return self.op(x)
class DilConv(nn.Module):
  ...
  def __init__(self, C_in, C_out, kernel_size, stride, padding, affine=True):
    ...
    self.op = nn.Sequential(
      nn.ReLU(inplace=False),
      D4_Conv2d(C_in, C_in, kernel_size=kernel_size, stride=stride, padding=padding, dilation=dilation, groups=C_in, bias=False),
      D4_Conv2d(C_in, C_out, kernel_size=1, padding=0, bias=False),
      AdaptiveBatchNorm2d(C_out, affine=affine),
      )
...
class SepConv(nn.Module):
  ...
  def __init__(self, C_in, C_out, kernel_size, stride, padding, affine=True):
    ...
    self.op = nn.Sequential(
      nn.ReLU(inplace=False),
      D4_Conv2d(C_in, C_in, kernel_size=kernel_size, stride=stride, padding=padding, groups=C_in, bias=False),
      D4_Conv2d(C_in, C_in, kernel_size=1, padding=0, bias=False),
      AdaptiveBatchNorm2d(C_in, affine=affine),
      nn.ReLU(inplace=False),
      D4_Conv2d(C_in, C_in, kernel_size=kernel_size, stride=1, padding=padding, groups=C_in, bias=False),
      D4_Conv2d(C_in, C_out, kernel_size=1, padding=0, bias=False),
      AdaptiveBatchNorm2d(C_out, affine=affine),
      )
...
class FactorizedReduce(nn.Module):
  ...
  def __init__(self, C_in, C_out, affine=True):
    ...
    self.conv_1 = D4_Conv2d(C_in, C_out // 2, 1, stride=2, padding=0, bias=False)
    self.conv_2 = D4_Conv2d(C_in, C_out // 2, 1, stride=2, padding=0, bias=False)
